  ...
  fetch(
    ...
    .then((json) => {
      ...
      if (cityHide.textContent == city) {
        ...
        const createCloneWithDeleteButton = (element) => {
        ...
        const elCloneInfoWeather = createCloneWithDeleteButton(infoWeather);
        const elCloneInfoHumidity = createCloneWithDeleteButton(infoHumidity);
        const elCloneInfoWind = createCloneWithDeleteButton(infoWind);
...
document.addEventListener("keydown", (event) => {
  ...
  if (event.key === "Backspace") {
    const activeClones = document.querySelectorAll(".active-clone");
